...
class CalculoService {
  ...
  static Resultado calcular({
    ...
    // Vazão total considerando número de gotejadores por planta
    final vazaoTotalMinuto = (cultura.vazao * cultura.gotejadores) / 60;

    // Tempo de irrigação em minutos
    final tempoMin = vazaoTotalMinuto > 0 ? volume / vazaoTotalMinuto : 0.0;
